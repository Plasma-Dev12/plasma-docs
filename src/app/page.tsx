    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center p-[32px] md:pt-[150px]">
        <div className="max-w-[1044px] h-full w-full border-2 border-[#8C93FB] bg-[#26215b94] p-[5px] md:p-[12] lg:p-[16] rounded-[16px] shadow-[0px_0px_149.8px_-31px_#6D60C1]">
          <div className="bg-[#0D1117] rounded-[16px] p-2 flex justify-center items-center">
            <h1
              id="title"
              className="font-extrabold max-h-[349px] text-md md:text-5xl xl:text-7xl 2xl:text-8xl text-center my-[100px]"
            >
              {selectedOption}
            </h1>
          </div>
        ...
        <div className="relative mt-5 md:hidden">
          ...
          >
            {selectedOption} <FaAngleDown className="text-[#F6E5F8]" />
          </button>
          {isOpen && (
